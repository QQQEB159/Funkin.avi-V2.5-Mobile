...
class SuperDuperMegaSecretTitleScreen extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		logoBl.scale.x = FlxMath.lerp(0.5, logoBl.scale.x, FlxMath.bound(1 - (elapsed * 1.995), 0, 1));
		logoBl.scale.y = FlxMath.lerp(0.5, logoBl.scale.y, FlxMath.bound(1 - (elapsed * 1.995), 0, 1));
