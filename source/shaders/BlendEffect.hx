...
class BlendEffect {
    public var shader(default, null):BlendEffectShader = new BlendEffectShader();

    public var blendMode(default, set):Int;

    function set_blendMode(val:Int):Int
    {
        blendMode = val;
        shader.blendMode.value = [val];
        return val;
    }
